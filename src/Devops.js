...
<Grid container lg={12} xs={12} >
  ...
  <Typography sx={{textAlign:'Left',fontSize:'28px',color:'#1F2937'}}>DevOps & Site Reliability Engineering</Typography>
</Grid>
</Grid>
<Grid container lg={10} xs={11} sx={{marginBottom:"30px",margin:'auto'}} >
<Grid item lg={10} xs={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>Our DevOps developer team can help you with all your DevOps needs. We can help you with:</Typography>
</Grid>
</Grid>
...
<Grid container spacing={2} lg={10.8}  sx={{margin:'auto'}}>	
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11}>
					  <Typography >Monitoring & Performance</Typography>
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11} xs={10}>
					  <Typography >Infrastructure security and maintenance</Typography>
...
<Grid item lg={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>FASTEST GROWING ORGANIZATION TRUST US</Typography>
              ...
              <Paper sx={{width:mobile?'100% ':'448px',height:'744px',position:'absolute',left:mobile?'0px':"800px",top:mobile?'500px':"150px"}}>
