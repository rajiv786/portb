...
<Grid item lg={10} xs={11} sx={{margin:'auto',marginTop:mobile?'50px':''}}>
    <Grid item lg={6}>
    <Typography sx={{textAlign:'left',color:'#E64B18'}}>HIRE US</Typography>
    </Grid>
  </Grid>
<Grid container lg={12} xs={12} >
  <Grid item lg={10}  xs={11} sx={{margin:'auto'}}>
  <Typography sx={{textAlign:'Left',fontSize:'28px',color:'#1F2937'}}>Get in Touch with Us to Discuss Your Project</Typography>
</Grid>
</Grid>
<Grid container lg={10} xs={11} sx={{marginBottom:"30px",margin:'auto'}} >
<Grid item lg={10} xs={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>Book a free consultation call to discuss your project and learn how we can support you.</Typography>
</Grid>
</Grid>
...
<Grid container spacing={2} lg={10.8}  sx={{margin:'auto'}}>	
					...
					<Grid item lg={11}>
					  <Typography >Fast, performant websites</Typography>
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11} xs={10}>
					  <Typography >Improve search engine rankings</Typography>
