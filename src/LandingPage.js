...
When You Need<br/>More than Just a website
  ...
  <Grid item md={12} lg={8} xs={8} sx={{display:'flex',justifyContent:mobile?"center":'left',marginLeft:mobile?'52px':'170px',marginTop:mobile?'18px':'-57px'}}>
    <Link to='./Our Services' style={{ textDecoration: "none", color: '#6B7280' }}>
      <Button variant='contained' sx={{ backgroundColor:'#FFFFFF', borderRadius: '8px', textTransform: 'none', fontSize: mobile ? "12px" : "16px", fontWeight: "500", lineHeight: "24px", width: mobile ? '44vh' : '151px', height: "58px", color: 'grey' }}>Our Services</Button>
    </Link>
  </Grid>
</Grid>
...
<Grid item xs={10}  lg={3.5}  sx={{margin:mobile?'auto':'auto',border:"1px solid red",borderRadius:"8px",marginTop:mobile?"26px":"0px"}} >
...
lineHeight: '24px',color: '#737373'}}>
				  We have the expertise to handle infrastructure and deployment for your web application. We offer support and maintenance services for your infrastructure.	   </Typography>
					   </Grid>
  
  </Grid>
  
</Grid>
<Grid item lg={3.5} xs={10} sx={{margin:mobile?'auto':'auto',border:"1px solid red",borderRadius:"8px",marginTop:"23px"}}>
				   <Grid item xs={10} lg={12} sx={{ margin: mobile ? 'auto' : 'auto' }}>
...
<Grid item lg={3.5} xs={10}   sx={{margin:mobile?'auto':'auto',border:"1px solid red",borderRadius:"8px",height:'266px',marginTop:"23px"}} >
					   <Grid item xs={10} lg={12} sx={{ margin: mobile ? 'auto' : 'auto' }}>
					   <Grid item lg={3.5} xs={12} sx={{ margin: 'initial' }}>
...
<Grid container lg={6} xs={10} sx={{margin:'auto',border:'1px solid black',borderRadius:'20px',marginTop:'40px'}}>
				   <Grid item lg={12} xs={12}>
				   <Typography sx={{ textAlign: 'center',marginTop:'40px' }}>Web frameworks</Typography>
			</Grid>
...
<Grid item lg={12} xs={12}>
				   <Typography sx={{ textAlign: 'center',marginTop:'40px' }}>Content management system CMS</Typography>
			</Grid>
...
<Grid item lg={12} xs={12}>
				   <Typography sx={{ textAlign: 'center',marginTop:'40px' }}>Deployment</Typography>
			</Grid>
    <Grid item lg={3} xs={12}>
  <Image
        Duration={0}
  ...
  <Image
      ...
      />
			   ...
			   <Grid container lg={7} xs={10} sx={{margin:'auto',border:'1px solid black',borderRadius:'20px',marginTop:'50px'}}>
<Grid item lg={12} xs={12}>
				   <Typography sx={{ textAlign: 'center',marginTop:'40px' }}>MarTech</Typography>
			</Grid>
