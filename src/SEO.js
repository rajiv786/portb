...
<Grid item lg={10} xs={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>Hire us now to optimize the technical aspects and boost your online presence</Typography>
</Grid>
</Grid>
