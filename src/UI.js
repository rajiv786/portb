...
function UI ()  {
  ...
  return (
    <Box>
      ...
      <Grid container lg={10} xs={12} sx={{margin:mobile?'auto':' 80px auto',marginBottom:"280px"}}>
...
<Grid container lg={12} xs={12} >
  ...
  <Typography sx={{textAlign:'Left',fontSize:'28px',color:'#1F2937'}}>Web Animations</Typography>
</Grid>
</Grid>
<Grid container lg={10} xs={11} sx={{marginBottom:"30px",margin:'auto'}} >
<Grid item lg={10} xs={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>Our web animations service helps you create engaging and immersive animations that bring your website to life.</Typography>
</Grid>
</Grid>
...
<Grid container spacing={2} lg={10.8}  sx={{margin:'auto'}}>	
					...
					<Grid item lg={11}>
					  <Typography >Interactive animations on buttons and menus</Typography>
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11}>
					  <Typography >Modern JS libraries: Three.js, ScrollMagic, GSAP</Typography>
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11} xs={10}>
					  <Typography >Loading page and content transitions</Typography>
...
<Grid item lg={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>FASTEST GROWING ORGANIZATION TRUST US</Typography>
              ...
              <Paper sx={{width:mobile?'100% ':'448px',height:'654px',position:'absolute',left:mobile?'0px':"800px",top:mobile?'500px':"150px",borderRadius:'8px',border:"1px solid #E5E7EB"}}>
