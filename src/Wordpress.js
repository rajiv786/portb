...
<Grid container lg={12} xs={12} >
  ...
  <Typography sx={{textAlign:'Left',fontSize:'28px',color:'#1F2937'}}> Wordpress Development</Typography>
</Grid>
</Grid>
<Grid container lg={10} xs={11} sx={{marginBottom:"30px",margin:'auto'}} >
<Grid item lg={10} xs={10} sx={{margin:'auto',marginLeft:'0px'}} >
  <Typography sx={{textAlign:'left',fontSize:'18px',marginTop:'20px',color:'#737373'}}>Get an experienced team of Wordpress for your new project.</Typography>
</Grid>
</Grid>
...
<Grid container spacing={2} lg={10.8}  sx={{margin:'auto'}}>	
            ...
            <Grid container spacing={2} lg={10.8} sx={{margin:'auto'}}>	
					...
					<Grid item lg={11} xs={10}>
					  <Typography >E-commerce Functionality</Typography>
